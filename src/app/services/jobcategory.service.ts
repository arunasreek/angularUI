...
export class JobCategoryService {
    ...
    getJobCategoryList() {
        return this.http.get<any>(`${this.config.apiEndpoint}/JobCategory/GetJobCategory`).pipe(map((data: any) => {
            return data;
        }));
    }
    setJobCategory(jobcategory:jobcategoryModel):Observable<any>{
        return this.http.post<any>(`${this.config.apiEndpoint}/JobCategory`,jobcategory);
    }
