...
import { IDashboardResponse, IRolePrevileges, IManageUserList, IUserStatus, IUserProfile, IUserChangePassword, IDashboardAndKPiResponse, IPulishStatus } from '../models';
